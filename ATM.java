...
public class ATM {
    ...
    public void run() {
        ...
        while (sessionActive) {
            ...
            switch (choice) {
                ...
                case 6:
                    sessionActive = false;
                    System.out.println("Thank you for using this Bank ATM. Goodbye Visit Again!");
                    break;
                default:
                    System.out.println("Invalid choice. Please enter a valid Given option.");
                    break;
            }
        }
        scanner.close();
    ...
    private void withdraw(Scanner scanner) {
        System.out.print("Enter Balance amount to withdraw: $");
    ...
    public static void main(String[] args) {
        // Example usage
        ATM atm = new ATM("Madhav Bhakare ", 1234);
        atm.run();
    }
}
